...
#include "Material_NoVSPGpuNaming.generated.h"

UCLASS()
class UMaterial_NoVSPGpuNaming : public UInspectionBase
{
	GENERATED_BODY()
...
class FInspectionTask_NoVSPGpuNaming final : public FInspectionTask
{
public:
