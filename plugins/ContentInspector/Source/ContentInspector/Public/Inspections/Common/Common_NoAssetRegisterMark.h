...
#include "Common_NoAssetRegisterMark.generated.h"

UCLASS()
class UCommon_NoAssetRegisterMark : public UInspectionBase
{
	GENERATED_BODY()
...
class FInspectionTask_NoAssetRegisterMark final : public FInspectionTask
{
public:
