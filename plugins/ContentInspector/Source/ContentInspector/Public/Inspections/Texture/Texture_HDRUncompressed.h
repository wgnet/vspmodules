...
#include "Texture_HDRUncompressed.generated.h"

UCLASS()
class CONTENTINSPECTOR_API UTexture_HDRUncompressed : public UInspectionBase
{
	GENERATED_BODY()
...
class FInspectionTask_HDRUncompressed final : public FInspectionTask
{
public:
