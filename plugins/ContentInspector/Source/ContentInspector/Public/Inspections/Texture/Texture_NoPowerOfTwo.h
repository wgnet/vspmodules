...
#include "Texture_NoPowerOfTwo.generated.h"

UCLASS()
class CONTENTINSPECTOR_API UTexture_NoPowerOfTwo : public UInspectionBase
{
...
class FInspectionTask_NoPowerOfTwo final : public FInspectionTask
{
public:
