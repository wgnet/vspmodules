...
#include "MaterialInstance_Warnings.generated.h"

UCLASS()
class UMaterialInstance_MIWarnings : public UInspectionBase
{
	GENERATED_BODY()
...
class FInspectionTask_MIWarnings final : public FInspectionTask
{
public:
