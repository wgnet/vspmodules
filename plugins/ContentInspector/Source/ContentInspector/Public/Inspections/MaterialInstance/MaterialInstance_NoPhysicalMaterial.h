...
#include "MaterialInstance_NoPhysicalMaterial.generated.h"

UCLASS()
class UMaterialInstance_NoPhysicalMaterial : public UInspectionBase
{
	GENERATED_BODY()
...
class FInspectionTask_NoPhysicalMaterial final : public FInspectionTask
{
public:
