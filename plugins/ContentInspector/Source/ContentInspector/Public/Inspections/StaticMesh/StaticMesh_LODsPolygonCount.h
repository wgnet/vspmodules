...
#include "StaticMesh_LODsPolygonCount.generated.h"

UCLASS()
class UStaticMesh_LODsPolygonCount : public UInspectionBase
{
	GENERATED_BODY()
...
class FInspectionTask_LODsPolygonCount final : public FInspectionTask
{
public:
