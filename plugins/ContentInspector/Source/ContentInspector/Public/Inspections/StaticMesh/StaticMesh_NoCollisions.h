...
#include "StaticMesh_NoCollisions.generated.h"

UCLASS()
class UStaticMesh_NoCollisions : public UInspectionBase
{
	GENERATED_BODY()
...
class FInspectionTask_NoCollisions final : public FInspectionTask
{
public:
