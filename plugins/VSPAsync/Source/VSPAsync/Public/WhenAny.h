...
{
	/**
        @brief   Create a task that will be executed when at least one of the input tasks is finished
        ...
        @retval                - a task that will be executed when at least one of the input tasks are finished
    **/
	template<class FailureType, class ContainerType>
	UE_NODISCARD TTaskPtr<void, void, FailureType> WhenAny(ContainerType& InputTasks);
    ...
    **/
	...
	UE_NODISCARD TTaskPtr<> WhenAny(ContainerType& InputTasks);
    ...
    **/
	...
	UE_NODISCARD TTaskPtr<void, void, FailureType> WhenAny(HeadTaskType& HeadTask, RestTasksType&&... RestTasks);
    ...
    **/
	...
	UE_NODISCARD TTaskPtr<> WhenAny(HeadTaskType& HeadTask, RestTasksType&&... RestTasks);
}
